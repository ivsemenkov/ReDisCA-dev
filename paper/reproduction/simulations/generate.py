...
except ImportError:  # script / pytest path bootstrap
    from config import SimulationConfig
    from forward_model import ForwardModel
...
def filter_gaussian_rows(
    ...
    *,
    ...
    """Z: Gaussian rows, 6th-order Butterworth low-pass (zero-phase SOS)."""
...
def source_erp(
    ...
    *,
    ...
    z = filter_gaussian_rows(
        rng, n_conditions, n_times, fs_hz=fs_hz, cutoff_hz=cutoff_hz, order=order
    )
    return mixing @ z, z
