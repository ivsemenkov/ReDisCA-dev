...
| SIM-P6 Figs 5–6 SNR=0.4 seeds 20240904–20240905; SNR=0.2 seed 20240904 | **Run** (~7.2–7.6 cm, no C-trend). Remaining P6 / all P4 Fig. 5/6 unfinished |
...
| SIM-R1 Fig. 4 seed 20240904 both SNRs; SNR=0.2 seed 20240905 | **Run** (near-chance / ~7–8 cm). Remaining R1 and all SIM-P8 unfinished |
...
**Incomplete (94 / 160 required n_mc=100 jobs).** The pre-registered
...
**SIM-P6 Figs 5–6** (three finished jobs, n_mc=100):
...
**SIM-R1 (D, composite)** Fig. 4, three finished jobs, n_mc=100.
Seed 20240904 SNR=0.2: AUC 0.493 / 7.94 cm; SNR=0.1: AUC 0.530 /
6.80 cm. Seed 20240905 SNR=0.2: AUC 0.508 / 7.05 cm. I_c=100 +
...
- **Fig. 18 (now run on the paper 3-D input):** lowest-*p* three
  ...
  verdict.
- **Simulations (94/160, not a verdict):** SIM-P3 causal Butterworth
  Fig. 4 is paper-like on all five seeds (median 0.88–1.13 cm at
  published SNR=0.1). SIM-P3 Fig. 5/6 is complete: C-trend present,
  but C=6 is 3.37–4.00 cm (paper &lt;2 cm). Three SIM-P6 Fig. 5/6
  jobs are ~7.3–7.6 cm with no C-trend. SIM-R1 Fig. 4 (three jobs)
